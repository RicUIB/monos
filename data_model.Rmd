...
```{r}
MBB_primates=read_csv("data/Different_MBB_Primates.csv")
```
...
```{r}
bonobo_gorila_core=read_tsv("data/Primates_bonobo_gorilla_core_summary.tsv")
bonobo_gorila_pan=read_tsv("data/Primates_bonobo_gorilla_pan_summary.tsv")
...
```{r}
library("sets")
bonobo_reactions=read_tsv("data/pathways/pps_summary.tsv")
reactions_bonobo=gsub(bonobo_reactions$reaction,pattern = "rn:",replacement ="")
gorila_reactions=read_tsv("data/pathways/ggo_summary.tsv")
